...
public class AttackAfterCondition implements Condition {
    public static final String CONDITION_NAME = "ATTACK_AFTER";

    private Target target;

    public AttackAfterCondition(ConditionLoaderDTO dto) {
        try {
    ...
    public AttackAfterCondition(ConditionEntity entity) {
    ...
    public boolean equals(Object o) {
        return o instanceof AttackAfterCondition && EqualsBuilder.reflectionEquals(this, o);
    }
    ...
    public String toString() {
        return String.format(
                "AttackAfterCondition [target=%s]", this.target);
    }
}
